...
# and a complex variable using command substitution.
#
...
# full weekday name of the day matching the date in variable
# BIRTHDATE e.g. Saturday.
#
# Note that the 'date' command can be used to convert a date format into a
